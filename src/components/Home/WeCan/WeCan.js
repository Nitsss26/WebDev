...
const WeCan = () => {
  ...
  return (
    <section className="py-24 -ms-64 -mt-5 me-16">
        ...
        <div className="relative rounded-3xl h-[400px] w-auto p-0">
          {
            services.map((i, k) => {
              return (
                <div key={k} className={`slide ${i.bgColour} flex justify-end flex-col items-center shadow-lg rounded-xl app__text ${activeSlide === k ? "activeSlider" : ""
                  }`}>
