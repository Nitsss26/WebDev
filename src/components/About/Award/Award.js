...
const Award = () => {
  ...
  const stats = [
    ...
    { id: 2, name: 'Happy Business Owners', value: <CountUp start={0} end={3080} duration={2} />, icon: UserIcon },
    ...
    <section className='bg-slate-100 -mt-20'>
      <div className="app__container py-16 sm:py-32">
        <div className='app__container'>
          <div className='grid grid-cols-1 ms-24 md:grid-cols-2'>
            <div>
              <h1 className='primary-heading mb-8'>Award Wining <br /><span className='highlight'>Digital Agency</span> We Are</h1>
              <p className='app__text font-bold'>Just the way you need to fill the appropriate colors for different types of sky, like orange for the sunset, pink and yellow for the sunrise, sky blue for a clear day, and dark blue for a stormy one. You get the impact of the painting from the specifics of the paints.</p>
            </div>
            <div className='mt-5 md:mt-9 md:ms-44 my-auto'>
              <ul className='list-image-[url(yes.png)] list-inside text-lg font-bold app__text'>
